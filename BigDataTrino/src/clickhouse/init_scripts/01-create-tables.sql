-- Создаем временную таблицу со всеми полями как String
CREATE TABLE bober_ch_db.mock_data_temp
(
    id String,
...
INSERT INTO bober_ch_db.mock_data_temp FROM INFILE '/tmp/data/MOCK_DATA (5).csv' FORMAT CSVWithNames;
INSERT INTO bober_ch_db.mock_data_temp FROM INFILE '/tmp/data/MOCK_DATA (6).csv' FORMAT CSVWithNames;
INSERT INTO bober_ch_db.mock_data_temp FROM INFILE '/tmp/data/MOCK_DATA (7).csv' FORMAT CSVWithNames;
INSERT INTO bober_ch_db.mock_data_temp FROM INFILE '/tmp/data/MOCK_DATA (8).csv' FORMAT CSVWithNames;
INSERT INTO bober_ch_db.mock_data_temp FROM INFILE '/tmp/data/MOCK_DATA (9).csv' FORMAT CSVWithNames;


-- Создаем финальную таблицу с правильными типами
CREATE TABLE bober_ch_db.mock_data
(
    id UInt32,
    customer_first_name String,
    customer_last_name String,
...
INSERT INTO bober_ch_db.mock_data
SELECT
    ...
    supplier_city,
    supplier_country
FROM bober_ch_db.mock_data_temp;

-- После проверки данных можно удалить временную таблицу
DROP TABLE bober_ch_db.mock_data_temp;
